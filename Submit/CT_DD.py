# This code is revised by heumtum from the original version of Qiskit for differing dd-sequences adjacent respectively to target and control qubits.(2022 Hackathon)
    ...
    def run(self, dag):
        ...
        for nd in dag.topological_op_nodes():
            if isinstance(nd.op, CXGate):
                #if there are several cnot gates in a row to make a swap gate, just select the default dd sequence(target)
