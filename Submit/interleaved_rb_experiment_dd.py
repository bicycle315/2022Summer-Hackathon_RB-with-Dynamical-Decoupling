...
from qiskit_experiments.library.randomized_benchmarking.interleaved_rb_analysis import InterleavedRBAnalysis

from qiskit.circuit.gate import Gate

class InterleavedRB_dd(StandardRB_dd): #revised the base class to StandardRB_dd
    ...
    def __init__(
        ...
        dd_sequence_target: Sequence[Gate]=None, #added attributes
        ...
        super().__init__(
            ...
            dd_sequence_target=dd_sequence_target,
            dd_sequence_control=dd_sequence_control
        )
